...
class Maximum_demand_register_Active_energy_import_A_Periodic : Extended_Register_Class
{
    ...
    class L1_Current : Extended_Register_Class
{
    public L1_Current(IEGReader eGReader) : base("1.0.31.16.0.255", eGReader) { }
}
class L1_Voltage : Extended_Register_Class
{
    public L1_Voltage(IEGReader eGReader) : base("1.0.32.13.0.255", eGReader) { }
}
class L1_Voltage2 : Extended_Register_Class
{
    public L1_Voltage2(IEGReader eGReader) : base("1.0.32.16.0.255", eGReader) { }
}
